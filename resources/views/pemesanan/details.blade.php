            ...
            <div class="card-body">
            	<table class="table">
        			...
        			<tr>
        				...
        				<td>: </td>
        				<td>{{ $data['kode_bkg'] }}</td>
                        <input type="hidden" name="kode_bkg" value="{{$data['kode_bkg']}}" required>
        			</tr>
        			<tr>
        				<th>Tanggal Pesan</th>
        				<td> : </td>
        				<td>{{ $data['tgl_psn'] }}</td>
                        <input type="hidden" name="tgl_psn" value="{{$data['tgl_psn']}}" required>
        			</tr>
        			<tr>
        				<th>Durasi</th>
        				<td> : </td>
                    ...
                    <tr>
                        <td colspan="3"><button href="#" data-toggle="modal" data-target="#paymentModal" type="button"> Pesan Sekarang </button></td>
                    </tr>
            	</table>
            </div>
            <!-- payment MODALS  -->
